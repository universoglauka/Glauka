...
<body>
  ...
  <h2>Te informamos que tu obra <strong>"{{ $obra->nombre_obra }}"</strong> fue dada de baja de la plataforma por <strong>decisión del equipo de administración</strong>.</h2>
  @else
  <h2>Confirmamos que hemos procesado la solicitud para dar de baja tu obra <strong>"{{ $obra->nombre_obra }}"</strong>.</h2>
  @endif
